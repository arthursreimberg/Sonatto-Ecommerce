...
CALL sp_CadastrarProduto( 'Cowbell Pearl 4 PCB4', 154.80, 'Tamanho pequeno 4" Ideal para colocar em cima do bumbo Timbre agudo Bom volume Com presilha móvel, pronto para encaixar no clamp', 'Pearl', 4.5, 'Percussão', 20, 1);
...
CALL sp_CadastrarProduto( 'Guitarra Jackson Arch Top JS22 Dinky DKA Metallic Blue', 1954.15, 'Rápidas, mortais e acessíveis, as guitarras da série Jackson JS dão um salto épico, tornando mais fácil do que nunca obter o tom clássico, a aparência e a tocabilidade da Jackson sem estourar o orçamento. O JS Series Dinky® Arch Top JS22 DKA tem um corpo de álamo ou nato (apenas óleo natural) com topo arqueado, braço de bordo parafusado de rápida execução com reforço de grafite e uma escala de amaranto com raio composto de 12"-16", encordoadas com 24 trastes jumbo e marcações peroladas de barbatana de tubarão. Um par de captadores humbucking de alta saída da Jackson com ímãs de cerâmica oferece um tom claro com muita densidade e pode ser moldado com um interruptor de três posições e controles individuais de volume e tom. Este modelo também apresenta hardware totalmente preto, incluindo uma ponte tremolo de fulcro sincronizado, botões de alça padrão e tarraxas fundidas.', 'Jackson', 4.5, 'Cordas', 20, 1);
